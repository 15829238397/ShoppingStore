package com.example.shoppingstore.widget;
...
import static com.example.shoppingstore.R.styleable.CnToolbar_isShowSearchView;
...
public class PbToolbar extends Toolbar{
    ...
    public PbToolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs , 0);
    }

    public PbToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void iniView() {
        if (mView == null) {
            ...
            mView = inflater.inflate(R.layout.toolbar_view, null);

            mSearchView = (EditText) mView.findViewById(R.id.toolBarSearchView);
            mTextTitle = (TextView) mView.findViewById(R.id.tab_title);
            mRightButton = (Button) mView.findViewById(R.id.right_button);
            mLeftImageButton = (ImageButton) mView.findViewById(R.id.left_button) ;
            mRightImageButton = (ImageButton) mView.findViewById(R.id.right_imagebutton) ;
            userPhoto = (ImageView) mView.findViewById(R.id.user_photo) ;

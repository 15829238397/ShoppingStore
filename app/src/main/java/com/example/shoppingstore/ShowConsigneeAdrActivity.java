...
import com.example.shoppingstore.Bean.ConsigneeMsg;
...
import com.example.shoppingstore.adapter.ConsigneeAddressAdapter;
...
public class ShowConsigneeAdrActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.show_deliveryaddres_view);
